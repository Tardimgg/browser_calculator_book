...
public class Main8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!base.output_check()) {
            ...
            if (size != 18 && !base.output_progress_boolean()) {
                ...
                //и отображаем его:
                mDialogBuilder.show();
            } else if (base.output_progress_size() != 18 && !base.output_check_box_size()) {
                base.input_check(false);
            } else if (base.output_check_box_size()) {
                base.input_check_box_size(false);
            }

            ViewPager pager = (ViewPager) findViewById(R.id.view8);
    ...
    public void transformText(int position, int stage) {
        ...
        if (position == 0) {
            ...
            if ((int) (text.getTextSize() / getApplicationContext().getResources().getDisplayMetrics().density) != size + 7.0f) {
                ...
                text.setText(R.string.view8_0_text0, TextView.BufferType.SPANNABLE);
                TextView text1 = (TextView) findViewById(R.id.textView2);
                text1.setTextSize(size);
                text1.setText(R.string.view8_0_text1, TextView.BufferType.SPANNABLE);
            }
        }
        if (position == 1 && (stage == 0 ? old_page != 1 : true)) {
            ...
            if ((int) (text_answer.getTextSize() / getApplicationContext().getResources().getDisplayMetrics().density) != size - 4.0f) {
                ...
                text_question.setText(R.string.view8_1_text0, TextView.BufferType.SPANNABLE);
                float size_button = size - 1.0f > 0 ? size - 1.0f : 1.0f;
                text_button0.setTextSize(size_button);
                text_button0.setText(R.string.view8_1_text1, Button.BufferType.SPANNABLE);
                text_button1.setTextSize(size_button);
                text_button1.setText(R.string.view8_1_text2, Button.BufferType.SPANNABLE);
                text_button2.setTextSize(size_button);
                text_button2.setText(R.string.view8_1_text3, Button.BufferType.SPANNABLE);
                text_button3.setTextSize(size_button);
                text_button3.setText(R.string.view8_1_text4, Button.BufferType.SPANNABLE);
            }
        }
        if (position == 2) {
            ...
            if ((int) (text.getTextSize() / getApplicationContext().getResources().getDisplayMetrics().density) != size + 7.0f) {
                text.setTextSize(size + 7.0f);
                text.setText(R.string.view8_2_text0, TextView.BufferType.SPANNABLE);
                TextView text1 = (TextView) findViewById(R.id.textView5);
                text1.setTextSize(size);
                text1.setText(R.string.view8_2_text1, TextView.BufferType.SPANNABLE);
            }
        }
        if (position == 3 && (stage == 0 ? old_page != 3 : true)) {
            ...
            if ((int) (text_answer.getTextSize() / getApplicationContext().getResources().getDisplayMetrics().density) != size - 4.0f) {
                ...
                text_question.setTextSize(size + 2.0f > 0 ? size + 2.0f : 1.0f);
                text_answer.setText(text_answer.getText(), TextView.BufferType.SPANNABLE);
                text_question.setText(R.string.view8_3_text0, TextView.BufferType.SPANNABLE);
                float size_button = size - 1.0f > 0 ? size - 1.0f : 1.0f;
                text_button0.setTextSize(size_button);
                text_button0.setText(R.string.view8_3_text1, Button.BufferType.SPANNABLE);
                text_button1.setTextSize(size_button);
                text_button1.setText(R.string.view8_3_text2, Button.BufferType.SPANNABLE);
                text_button2.setTextSize(size_button);
                text_button2.setText(R.string.view8_3_text3, Button.BufferType.SPANNABLE);
                text_button3.setTextSize(size_button);
                text_button3.setText(R.string.view8_3_text4, Button.BufferType.SPANNABLE);
        ...
        if (position == 4) {
            ...
            if ((int) (text.getTextSize() / getApplicationContext().getResources().getDisplayMetrics().density) != size + 7.0f) {
                text.setTextSize(size + 7.0f);
                text.setText(R.string.view8_4_text0, TextView.BufferType.SPANNABLE);
                TextView text1 = (TextView) findViewById(R.id.textView22);
                text1.setTextSize(size);
                text1.setText(R.string.view8_4_text1, TextView.BufferType.SPANNABLE);
                TextView text2 = (TextView) findViewById(R.id.textView);
                text2.setTextSize(size);
                text2.setText(R.string.view8_4_text2, TextView.BufferType.SPANNABLE);
            }
        }
        if (position == 5 && (stage == 0 ? old_page != 3 : true)) {
            Button text_button0 = (Button) findViewById(R.id.button161);
            Button text_button1 = (Button) findViewById(R.id.button151);
            Button text_button2 = (Button) findViewById(R.id.button141);
            Button text_button3 = (Button) findViewById(R.id.button131);
            Button text_button_answer = (Button) findViewById(R.id.button17);
            TextView text_question = (TextView) findViewById(R.id.textView171);
            TextView text_answer = (TextView) findViewById(R.id.textView81);
            if (stage == 0) {
                text_button0.setTransformationMethod(null);
                text_button1.setTransformationMethod(null);
                text_button2.setTransformationMethod(null);
            ...
            if ((int) (text_answer.getTextSize() / getApplicationContext().getResources().getDisplayMetrics().density) != size - 4.0f) {
                ...
                text_question.setTextSize(size + 2.0f > 0 ? size + 2.0f : 1.0f);
                text_answer.setText(text_answer.getText(), TextView.BufferType.SPANNABLE);
                text_question.setText(R.string.view8_5_text0, TextView.BufferType.SPANNABLE);
                float size_button = size - 1.0f > 0 ? size - 1.0f : 1.0f;
                text_button0.setTextSize(size_button);
                text_button0.setText(R.string.view8_5_text1, Button.BufferType.SPANNABLE);
                text_button1.setTextSize(size_button);
                text_button1.setText(R.string.view8_5_text2, Button.BufferType.SPANNABLE);
                text_button2.setTextSize(size_button);
                text_button2.setText(R.string.view8_5_text3, Button.BufferType.SPANNABLE);
                text_button3.setTextSize(size_button);
                text_button3.setText(R.string.view8_5_text4, Button.BufferType.SPANNABLE);
    ...
    public void onClick8(View view) {
        ...
        TextView x = (TextView) findViewById(R.id.textView81);
        if (!check1) {
            x.setText("Вы не выполнили либо выполнили неправильно предыдущии задания");
            TextView button = (TextView) findViewById(R.id.button161);
            button.setBackgroundResource(R.drawable.full_wrong);
            full_wrong = MediaPlayer.create(this, R.raw.full_wrong);
            full_wrong.start();
            check_music_wrong = true;
    ...
    public void onClick9(View view) {
        ...
        if (!check1) {
            x.setText("Вы не выполнили либо выполнили неправильно предыдущии задания");
            TextView button = (TextView) findViewById(R.id.button151);
            button.setBackgroundResource(R.drawable.full_wrong);
            full_wrong = MediaPlayer.create(this, R.raw.full_wrong);
            full_wrong.start();
            check_music_wrong = true;
    ...
    public void onClick10(View view) {
        ...
        if (!check1) {
            x.setText("Вы не выполнили либо выполнили неправильно предыдущии задания");
            TextView button = (TextView) findViewById(R.id.button141);
            button.setBackgroundResource(R.drawable.full_wrong);
            full_wrong = MediaPlayer.create(this, R.raw.full_wrong);
            full_wrong.start();
            check_music_wrong = true;
    ...
    public void onClick11(View view) {
        ...
        if (!check1) {
            x.setText("Вы не выполнили либо выполнили неправильно предыдущии задания");
            TextView button = (TextView) findViewById(R.id.button131);
            button.setBackgroundResource(R.drawable.full_wrong);
            full_wrong = MediaPlayer.create(this, R.raw.full_wrong);
            full_wrong.start();
            check_music_wrong = true;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getSupportActionBar().setTitle("Переменные");
